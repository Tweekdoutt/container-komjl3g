...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-komjl3g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-komjl3g.containers.anotherwebservice.com/
...
```
git clone git@github.com:Tweekdoutt/container-komjl3g.git
cd container-komjl3g
```
...
```
docker attach container-komjl3g
```
